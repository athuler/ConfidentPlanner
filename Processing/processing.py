...
def main(argv=None) -> int:
    ...
    ap.add_argument("--max-null-frac", type=float, default=1.0,
                    help="drop columns with more than this fraction of values missing/empty (default 1.0 = keep everything; "
                         "the model-training dataset uses 0.6)")
